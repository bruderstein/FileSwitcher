...
#include "../src/precompiledHeaders.h"
...
void StaticDialog::goToCenter()
{
	...
	::SetWindowPos(_hSelf, _hParent, x, y, _rc.right - _rc.left, _rc.bottom - _rc.top, SWP_SHOWWINDOW);
}
...
void StaticDialog::create(int dialogID, bool isRTL, bool msgDestParent)
{
	...
	if (!_hSelf)
	{
		...
		char errMsg[256];
		sprintf_s(errMsg, sizeof(errMsg), "CreateDialogParam() return NULL.\rGetLastError() == %u", err);
